...
import com.tedmob.moph.tracer.bluetooth.BLEScanner
import com.tedmob.moph.tracer.logging.CentralLog
import com.tedmob.moph.tracer.services.BluetoothMonitoringService.Companion.infiniteScanning
...
//        discoverer.cancelDiscovery()
    ...
    fun isScanning(): Boolean = scannerCount > 0
