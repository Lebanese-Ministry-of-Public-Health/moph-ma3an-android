...
import com.tedmob.moph.tracer.services.BluetoothMonitoringService.Companion.PUSH_NOTIFICATION_ID
...
class FCMService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        //fixme all handled from OneSignal for now; will see if this behavior is to be fixed or not for the force update
    }
