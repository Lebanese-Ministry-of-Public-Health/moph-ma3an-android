...
import com.tedmob.moph.tracer.streetpass.view.StreetPassRecordViewModel


class RecordListAdapter internal constructor(context: Context) : RecyclerView.Adapter<RecordListAdapter.RecordViewHolder>() {
    ...
    private fun prepareCollapsedData(words: List<StreetPassRecord>): List<StreetPassRecordViewModel> {
        ...
        val countMap = words.groupBy { it.modelC }
