package com.tedmob.moph.tracer.bluetooth
...
import com.tedmob.moph.tracer.services.BluetoothMonitoringService.Companion.infiniteAdvertising
import java.util.*
...
class BLEAdvertiser constructor(val serviceUUID: String) {
    ...
    private var callback: AdvertiseCallback = object : AdvertiseCallback() {
        ...
        override fun onStartFailure(errorCode: Int) {//fixme attempt advertising sooner when error occurs
